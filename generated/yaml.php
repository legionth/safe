 ...
 *
 */
function yaml_parse_file(string $filename, int $pos = 0, &$ndocs = null, array $callbacks = null)
{
    error_clear_last();
 ...
 *
 */
function yaml_parse_url(string $url, int $pos = 0, &$ndocs = null, array $callbacks = null)
{
    error_clear_last();
 ...
 *
 */
function yaml_parse(string $input, int $pos = 0, &$ndocs = null, array $callbacks = null)
{
    error_clear_last();
